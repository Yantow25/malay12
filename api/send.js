...
export default async function handler(req, res) {
  if (req.method === "POST") {
    ...
    const token = "7587475236:AAFPGaxTdMi2uCZERLYcqBdoCH5KD3NWhws"; // Replace with your actual bot token
    const chatIds = ["6987171667", "5668468188"]; // Replace with your actual chat IDs
